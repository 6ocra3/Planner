...
import {
  fetchChangeDayValue,
  fetchChangeListOrder,
  fetchChangeStatus,
  fetchChangeTrackerOrder,
  fetchDeleteTask
  ...
  switch (action.type) {
    ...
    case "change_week":
      return {
        ...
        mondayDate: action.payload.mondayDate,
        trackerOrder: action.payload.week.tracker_order,
    ...
    case "change_display":
      ...
      temp_tasks[action.payload.task].days[action.payload.day] =
        (temp_tasks[action.payload.task].days[action.payload.day] + 1) % 4;
